...
pokemonContainer.innerHTML = ''
  pokemons.map((pokemon) => {
    ...
    pokemon.type.map((type) => {
      ...
      <span class="${type === 'Fire' ? 'type-fire' :  type === 'Flying' ? 'type-Flying' : type === 'Grass' ? 'type-Grass' : type === 'Poison' ? 'type-Poison' : type === 'Water' ? 'type-Water' : type === 'Bug' ? 'type-Bug' : type === 'Electric' ? 'type-Electric' : type === 'Normal' ? 'type-Normal' : type === 'Ground' ? 'type-Ground' : type === 'Rock' ? 'type-Rock' : type === 'Dragon' ? 'type-Dragon' : type === 'Psychic' ? 'type-Psychic' : type === 'Fighting' ? 'type-Fighting' : type === 'Ghost' ? 'type-Ghost' : type === 'Ice' ? 'type-Ice' : '' }">${type}</span>`
